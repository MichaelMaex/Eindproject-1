...
\begin{remark}
	A group ring in general is not commutative. In fact $\mathbb{K}[G]$ is commutative if and only if $gG$ is a commutative group. So we will have to be careful when dealing with these rings. 
\end{remark}
