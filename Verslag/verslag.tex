...
\begin{example}
	...
	\begin{description}
		...
		\item[$\card{H} > 1$:] 
			...
			.\]
			Thus \[
				\card{\{x_1,x-1^{-1}, \ldots, x_n, x_n^{-1}\}H \setminus H} \ge (2n - 2) \card{H}.
...
\end{corollary}	
\begin{proof}
	As $\phi$ commutes with the right shift  $\sigma_k$ we know that $\sigma_k \circ \phi = \phi \circ \sigma_k$. Applying the previous lemma immediately gives the result.
\end{proof}
