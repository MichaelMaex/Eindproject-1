\ll\documentclass[titlepage, a4paper]{article}
...
\\
Suppose now that $G$ is sofic and $\Sigma := \{\Phi_i: G \to Sym(d_i)\}_{i \in \N}$ a sofic approximation sequence. Take a subshift $X$ and a finite subset $F \subset G$. For any $\delta > 0$ and $n \in \N$ we define the function
