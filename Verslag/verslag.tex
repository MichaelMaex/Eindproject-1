...
\begin{definition}{}\label{def:Sofic}
    ...
    In fact there are no known examples of non-sofic groups \todo{reference for no known non-sofic}. 
...
\]
	...
	Now I claim that $\Gamma = \bigcup_{(i,a) \in K} \Gamma_{i,a}$ is set we are looking for. 
	...
	We conclude that $\Gamma$ is indeed the set we are looking for.
\end{proof}
...
\end{proof}
	...
	\section{Group rings are rings}\label{sec:proof_groupring}
